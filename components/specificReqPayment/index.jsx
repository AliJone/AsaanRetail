...
const CustomizePayment = () => {
    ...
    const Title = <>Pay for Your <span className={cn(style.underLine)}><span/>specific</span> requirements</>

    const subtTitle = "Use our plan customizer to create your need specific plans.";
