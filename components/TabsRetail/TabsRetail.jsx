  ...
  const tabsData = [
    {
      ...
      content: {
        ...
        subTitle:
          "Asaan Retail streamlines inventory, simplifies multichannel orders, and ensures precise financial control. No more overselling or financial headaches. With Asaan Retail, you'll elevate efficiency, reduce errors, and increase profitability.",
        offerings: [
        ...
        <div className={cn(limit.Limit)}>
          <div className={styles.Container}>
            ...
            <div className={styles.Body}>
              <Tabs
                className={cn(styles.DekstopView, styles.TabsMain)}
                defaultActiveKey="1"
                centered
              >
