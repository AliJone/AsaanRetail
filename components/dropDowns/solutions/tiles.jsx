      ...
      <div className={cn(style.TilesContainer)}>
        <div className={cn(style.tilesRow)}>
          <DropDownTile
            ...
            content={TilesSolution[0].content}
            title={TilesSolution[0].title}
            image={Accounting}
          />
          <DropDownTile
            handleClick={handleEcommerce}
            content={TilesSolution[1].content}
        ...
        <div className={cn(style.tilesRow)}>
          <DropDownTile
            ...
            content={TilesSolution[2].content}
            title={TilesSolution[2].title}
            image={Accounting}
          />
          <DropDownTile
            handleClick={handleAgencies}
            content={TilesSolution[3].content}
        ...
        <div className={cn(style.tilesRow, style.lengthFifty)}>
          <DropDownTile
            ...
            content={TilesSolution[4].content}
