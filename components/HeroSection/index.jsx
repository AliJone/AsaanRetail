    ...
    <div className={style.heroSectionClass}>
      <Row gutter={24}>
        <div className={cn(style.divParent)}>
          <Col span={12}>
            <div className={style.divLeftColumn}>
              <TextDiv
                TextB4ColorText={LandingPageText.TextB4ColorText}
                TextColorText={LandingPageText.TextColorText}
                TextAfterColorText={LandingPageText.TextAfterColorText}
                TextAfterColorText2={LandingPageText.TextAfterColorText2}
              />
              ...
              <span className={style.TextClass}>
                Centralized{" "}
                <b>
                  Inventory, Orders, Shipments, and
        ...
        <div className={style.divParentMobile}>
          <Col span={24}>
            <div className={style.divLeftColumn}>
              <span className={cn(style.TextClass)}>
                {`${LandingPageText.TextB4ColorText} ${LandingPageText.TextColorText}`}{" "}
                <br />{" "}
                {`${LandingPageText.TextAfterColorText} ${LandingPageText.TextAfterColorText2}`}
              </span>
              ...
              <span className={style.TextClassSmall}>
                Centralized{" "}
                <b>Inventory, Orders, Shipments, and Accounting Software</b> for
                Multi-
                <br />
                Channel Commerce
              </span>
              ...
              <div className={cn(style.centering)}>
                <CustomFilledButton
                  width={"86%"}
                  children={
                    <div className={cn(style.FilledButtonText)}>
                      Start Free Trial
                    </div>
                  }
                  handleClick={() => {}}
