...
const Responsibilities =[
    {'title':'Responsibilities','Bullets':['Work with the Product Development team on new features and releases.','Analyze, propose and drive technology improvements.','Build efficient, testable, and reusable modules.','You will have the room to work on new features while maintenance and improvement in the current product will also play a big part in your role.']},
    {'title':'Responsibilities','Bullets':['Work with the Product Development team on new features and releases.','Analyze, propose and drive technology improvements.','Build efficient, testable, and reusable modules.','You will have the room to work on new features while maintenance and improvement in the current product will also play a big part in your role.']},
    {'title':'Responsibilities','Bullets':['Work with the Product Development team on new features and releases.','Analyze, propose and drive technology improvements.','Build efficient, testable, and reusable modules.','You will have the room to work on new features while maintenance and improvement in the current product will also play a big part in your role.']},
]
                            ...
                            JobsDetails.map((item,index)=>{
                                return(
                                    <div className={cn(style.jobCard)}>
                                        <span className={cn(style.jobCardTitle)}>
                                            {item.title}
                                        </span>
