            ...
            <div className={cn(style.BG)}>
                <div className = {cn(limit.Limit)}>
                    <div className={cn(style.TitleContainer)}>
                        <span className = {cn(style.TitleText)}>All your <span className={cn(style.isDesktop)}>integrations</span><span className={cn(style.isMobile, style.underLine)}>integrations</span> in one place</span>
                    </div>
                    ...
                    <div className={cn(style.ButtonClass)}>
                        <CustomFilledButton children={<span className={cn(style.FilledButtonText)}>View All</span>} width={"100%"} handleClick={()=>{}}  />
                    </div>
                </div>
            </div>
        </div>
