            ...
            <ScrollAnimation animateOnce={true} animateIn="animate__fadeInUp">
              <div className={styles.Head}>
                ...
                <div className={styles.HeadSubTitle}>
                  <h4>
                    Founded in 2021, Asaan Retail started with a vision to
                    address the challenges faced by businesses in the digital
                    era. Over the years, we have evolved into a leading provider
                    of comprehensive software solutions, catering to diverse
            ...
            <ScrollAnimation animateOnce={true} animateIn="animate__fadeInUp">
              <div className={styles.End}>
                <div className={styles.EndText}>
                  <p>
                    Driven by a team of passionate professionals, our journey
                    has been shaped by continuous learning, adaptation, and a
                    commitment to customer satisfaction. With each milestone
                    achieved, we have forged strong partnerships and built a
